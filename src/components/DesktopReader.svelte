  ...
  <div style="max-width:760px;margin:0 auto;padding:32px 24px 56px;">
        ...
        <div style="padding:24px;border-radius: var(--radius-xl);background:var(--bg-elevated);border:1px solid var(--border-subtle);box-shadow:0 16px 36px rgba(24,24,24,0.05);">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;margin-bottom:18px;">
            <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
              <div style="width:30px;height:30px;border-radius: var(--radius-round);display:flex;align-items:center;justify-content:center;background:{meta.bg};color:{meta.color};font-size: var(--text-sm);font-weight: 700;">{i + 1}</div>
          ...
          {#if card.t === 'fact' && connections.length > 0}
            <span style="font-size: var(--text-xs);font-weight:700;color:var(--text-muted);margin-top:14px;display:block;">Tracked in {connections.length} {connections.length === 1 ? 'issue' : 'issues'}</span>
          {/if}
        </div>
      </div>
    {/each}
    ...
    <div style="margin-top:20px;padding:24px;border-radius: var(--radius-xl);border:1px solid rgba(46,125,50,0.16);background:linear-gradient(180deg, rgba(46,125,50,0.08) 0%, rgba(255,255,255,0.92) 100%);">
          ...
          <div style="display:flex;flex-direction:column;gap:6px;">
            {#each connections as conn}
              <button
                ...
                style="display:flex;align-items:center;gap:10px;padding:10px 14px;border-radius: var(--radius-md);background:var(--bg-elevated);border:1px solid var(--border-subtle);cursor:pointer;text-align:left;width:100%;transition:background var(--duration-fast, 150ms) ease;"
      ...
      {#if issue.stageScores && issue.finalScore}
        <div style="margin:0 0 20px;padding:18px;background:var(--bg-elevated);border-radius: var(--radius-lg);border:1px solid var(--border-subtle);">
