...
<button
  ...
  style="
    ...
    border:1px solid {reacted ? '#FFC9C9' : '#E9ECEF'};
    background:{reacted ? '#FFF5F5' : '#F8F9FA'};
...
>
  <svg width="14" height="14" viewBox="0 0 24 24" fill={reacted ? '#E03131' : 'none'} stroke={reacted ? '#E03131' : '#ADB5BD'} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="transition:fill 0.15s ease,transform 0.25s cubic-bezier(.175,.885,.32,1.275);transform:scale({reacted && scale > 1 ? 1.3 : 1});">
    <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
  </svg>
  <span style="font-size:11px;font-weight:600;color:{reacted ? '#E03131' : '#ADB5BD'};transition:color 0.15s ease;min-width:14px;text-align:center;">{count}</span>
</button>
