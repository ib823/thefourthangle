...
Audit of all 90 published issues against the new accuracy + editorial criteria from CLAUDE.md (Accuracy Standard) and `docs/research/bite-size-reading.md`. Generated by `scripts/audit-published.mjs`.

## Summary

| Metric | Value |
|---|---:|
| Total published issues | 90 |
...
### Unauditable issues — zero engine artifacts (69)
...
- **0146** — 2.5 Million Workers With Zero Safety Net
...
- **0170** — The Top 20% Own Nearly Everything
...
- **1071** — Putrajaya's RM1.4 billion smart city project has zero measurable outcomes
- **1074** — RM23 billion MRT3 project awarded without competitive international tender
- **1077** — Government's RM680 million advertising spend lacks transparency
- **1100** — Customs scandal: 47 containers of sanctioned goods cleared without inspection
- **1102** — Subsidy rationalisation saved RM14 billion but delivery mechanism leaks 30%
- **1115** — Cabinet committees bypass parliament on 23 policy decisions
- **1120** — Malaysia's overall governance score dropped 8 points in 3 years — worst in decade
- **1128** — Gig Workers Exceed 1.3 Million Without Social Protection
...
- **1190** — EPF Account 3 Withdrawals Hit RM12B in First 8 Months
...
- **1267** — Migrant worker exploitation affects 2.1 million documented workers
...
- **1325** — Suriani ruling on maternal citizenship rights faces government appeal
...
- **1618** — Islamic State Debate Returns as PAS Governs 6 States
...
- **1751** — MRT3 Circle Line Budget Balloons to RM45 Billion
- **1805** — Abandoned LCS Programme Wastes RM6.1 Billion on Zero Ships
- **1867** — MACC Investigation Into 1MDB Asset Recovery Reaches RM12 Billion
